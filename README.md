...
```sh
git clone https://github.com/hassan0smp/swissTronik-Deploy-Proxy.git
...
12. Now visit : [Click Here](https://github.com/hassan0smp/swissTronik-Deploy-Proxy/blob/main/upload-to-github.md) to upload these codes in your github repository.
## Done!
